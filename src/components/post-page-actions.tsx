...
export function LLMCopyButton({ markdownUrl }: { markdownUrl: string }) {
  ...
  return (
    <button
      className="flex h-8 items-center gap-1.5 rounded-l-lg pr-2.5 pl-2.5 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-zinc-100/80 dark:hover:bg-white/[0.06] disabled:pointer-events-none disabled:opacity-50"
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex size-8 items-center justify-center rounded-r-lg text-muted-foreground hover:text-foreground hover:bg-zinc-100/80 dark:hover:bg-white/[0.06]">
...
export function LLMCopyButtonWithViewOptions({
  ...
  return (
    <div
      className={cn(
        "inline-flex items-center gap-0 rounded-lg border border-zinc-200/80 dark:border-white/[0.08] bg-white/60 dark:bg-zinc-900/60 backdrop-blur-sm divide-x divide-zinc-200/80 dark:divide-white/[0.08]"
      )}
    >
