...
image: https://assets.gowthamdev.com/images/blog/work-experience-component.webp?t=1750149861
category: components
...
```bash
npx shadcn@latest add https://gowthamdev.com/r/work-experience.json
```
