...
image: https://assets.gowthamdev.com/images/blog/writing-effect-inspired-by-apple.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://gowthamdev.com/r/apple-hello-effect.json"
  canReplay
/>
...
```bash
npx shadcn@latest add https://gowthamdev.com/r/apple-hello-effect.json
```
