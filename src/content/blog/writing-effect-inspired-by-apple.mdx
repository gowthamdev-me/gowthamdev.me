...
image: https://assets.gowthamdev.me/images/blog/writing-effect-inspired-by-apple.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://gowthamdev.me/r/apple-hello-effect.json"
  canReplay
/>
...
```bash
npx shadcn@latest add https://gowthamdev.me/r/apple-hello-effect.json
```
