...
image: https://assets.gowthamdev.com/images/blog/theme-switcher-component.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://gowthamdev.com/r/theme-switcher.json"
/>
...
```bash
npx shadcn@latest add https://gowthamdev.com/r/theme-switcher.json
```
