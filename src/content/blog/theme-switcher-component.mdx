...
image: https://assets.gowthamdev.me/images/blog/theme-switcher-component.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://gowthamdev.me/r/theme-switcher.json"
/>
...
```bash
npx shadcn@latest add https://gowthamdev.me/r/theme-switcher.json
```
